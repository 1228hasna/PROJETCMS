...
function jewellery_shop_custom_styles($custom) {
	//Fonts
	...
	wp_add_inline_style( 'jewellery-shop-basic-style', $custom );
}
add_action( 'wp_enqueue_scripts', 'jewellery_shop_custom_styles' );

//Sanitizes Fonts
function jewellery_shop_sanitize_fonts( $input ) {
	$valid = array(
