...
if ( class_exists("Kirki")){
	...
	Kirki::add_panel( 'jeweller_store_panel_id_1', array(
	    'priority'    => 10,
	    'title'       => esc_html__( 'Typography', 'jeweller-store' ),
	) );

	Kirki::add_section( 'jeweller_store_font_style_section', array(
		'title'      => esc_html__( 'Typography Option',  'jeweller-store' ),
		'panel'          => 'jeweller_store_panel_id_1',
		'priority'   => 2,
		'capability' => 'edit_theme_options',
	) );

	Kirki::add_field( 'theme_config_id', [
	    'label'       => '<span class="custom-label-class">' . esc_html__( 'INFORMATION ABOUT PREMIUM VERSION :-', 'jeweller-store' ) . '</span>',
	    'default'     => '<a class="premium_info_btn" target="_blank" href="' . esc_url( JEWELLER_STORE_BUY_NOW ) . '">' . __( 'GO TO PREMIUM', 'jeweller-store' ) . '</a>',
	    'type'        => 'custom',
	    'section'     => 'jeweller_store_font_style_section',
	    'description' => '<div class="custom-description-class">' . __( '<p>1. One Click Demo Importer </p><p>2. More Font Family Options </p><p>3. Color Pallete Setup </p><p>4. Section Reordering Facility</p><p>5. For More Options kindly Go For Premium Version.</p>', 'jeweller-store' ) . '</div>',
	] );
	...
	Kirki::add_field( 'global', array(
		'type'        => 'typography',
		'settings'    => 'jeweller_store_all_headings_typography',
		'label'       => esc_html__( 'Heading Typography',  'jeweller-store' ),
		'description' => esc_html__( 'Select the typography options for your heading.',  'jeweller-store' ),
		'section'     => 'jeweller_store_font_style_section',
		'priority'    => 10,
		'default'     => array(
			'font-family'    => '',
	...
	Kirki::add_field( 'global', array(
		'type'        => 'typography',
		'settings'    => 'jeweller_store_body_content_typography',
		'label'       => esc_html__( 'Content Typography',  'jeweller-store' ),
		'description' => esc_html__( 'Select the typography options for your content.',  'jeweller-store' ),
		'section'     => 'jeweller_store_font_style_section',
		'priority'    => 10,
		'default'     => array(
			'font-family'    => '',
	...
	// PANEL
	Kirki::add_panel( 'jeweller_store_panel_id_2', array(
	    'priority'    => 10,
	    'title'       => esc_html__( 'Theme Dark Mode', 'jeweller-store' ),
	) );

	// DARK MODE SECTION
	Kirki::add_section( 'jeweller_store_section_dark_mode', array(
	    'title'          => esc_html__( 'Dark Mode', 'jeweller-store' ),
	    'panel'          => 'jeweller_store_panel_id_2',
	    'priority'       => 160,
	) );
	...
	Kirki::add_field( 'theme_config_id', [
	    ...
	    'default'     => '<a class="premium_info_btn" target="_blank" href="' . esc_url( JEWELLER_STORE_BUY_NOW ) . '">' . __( 'GO TO PREMIUM', 'jeweller-store' ) . '</a>',
	    'type'        => 'custom',
	    'section'     => 'jeweller_store_section_dark_mode',
	    'description' => '<div class="custom-description-class">' . __( '<p>1. One Click Demo Importer </p><p>2. Color Pallete Setup </p><p>3. Section Reordering Facility</p><p>4. For More Options kindly Go For Premium Version.</p>', 'jeweller-store' ) . '</div>',
	]);

	Kirki::add_field( 'theme_config_id', [
	    'type'        => 'custom',
	    'settings'    => 'jeweller_store_dark_colors',
	    'section'     => 'jeweller_store_section_dark_mode',
	    'default'     => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Dark Appearance', 'jeweller-store' ) . '</h3>',
	    'priority'    => 10,
	]);

	Kirki::add_field( 'theme_config_id', [
		'type'        => 'switch',
		'settings'    => 'jeweller_store_is_dark_mode_enabled',
		'label'       => esc_html__( 'Turn To Dark Mode', 'jeweller-store' ),
		'section'     => 'jeweller_store_section_dark_mode',
		'default'     => false,
		'priority'    => 10,
		'choices'     => [
	...
	// PANEL
	Kirki::add_panel( 'jeweller_store_panel_id_5', array(
	    'priority'    => 10,
	    'title'       => esc_html__( 'Theme Animations', 'jeweller-store' ),
	) );

	// DARK MODE SECTION
	Kirki::add_section( 'jeweller_store_section_animation', array(
	    'title'          => esc_html__( 'Animations', 'jeweller-store' ),
	    'panel'          => 'jeweller_store_panel_id_5',
	    'priority'       => 160,
	) );
	...
	Kirki::add_field( 'theme_config_id', [
	    ...
	    'default'     => '<a class="premium_info_btn" target="_blank" href="' . esc_url( JEWELLER_STORE_BUY_NOW ) . '">' . __( 'GO TO PREMIUM', 'jeweller-store' ) . '</a>',
	    'type'        => 'custom',
	    'section'     => 'jeweller_store_section_animation',
	    'description' => '<div class="custom-description-class">' . __( '<p>1. One Click Demo Importer </p><p>2. Color Pallete Setup </p><p>3. Section Reordering Facility</p><p>4. For More Options kindly Go For Premium Version.</p>', 'jeweller-store' ) . '</div>',
	]);

	Kirki::add_field( 'theme_config_id', [
		'type'        => 'switch',
		'settings'    => 'jeweller_store_animation_enabled',
		'label'       => esc_html__( 'Turn To Show Animation', 'jeweller-store' ),
		'section'     => 'jeweller_store_section_animation',
		'default'     => true,
		'priority'    => 10,
		'choices'     => [
	...
	Kirki::add_section( 'jeweller_store_section_color', array(
	    'title'          => esc_html__( 'Global Color', 'jeweller-store' ),
	...
	Kirki::add_field( 'theme_config_id', [
		...
		'default'     => '<a class="premium_info_btn" target="_blank" href="' . esc_url( JEWELLER_STORE_BUY_NOW ) . '">' . __( 'GO TO PREMIUM', 'jeweller-store' ) . '</a>',
	    'type'        => 'custom',
	    'section'     => 'jeweller_store_section_color',
	    'description' => '<div class="custom-description-class">' . __( '<p>1. One Click Demo Importer </p><p>2. Color Pallete Setup </p><p>3. Section Reordering Facility</p><p>4. For More Options kindly Go For Premium Version.</p>', 'jeweller-store' ) . '</div>',
	] );

	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'settings'    => 'jeweller_store_global_colors',
		'section'     => 'jeweller_store_section_color',
		'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Here you can change your theme color on one click.', 'jeweller-store' ) . '</h3>',
		'priority'    => 10,
	] );

	Kirki::add_field( 'theme_config_id', [
		'type'        => 'color',
		'settings'    => 'jeweller_store_global_color',
		'label'       => __( 'choose your Appropriate Color', 'jeweller-store' ),
		'section'     => 'jeweller_store_section_color',
		'default'     => '#b2905f',
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'color',
		'settings'    => 'jeweller_store_global_color_2',
		'label'       => __( 'Choose Your Second Color', 'jeweller-store' ),
		'section'     => 'jeweller_store_section_color',
		'default'     => '#33302d',
	] );
	...
	[
		...
		'choices'     => [
			'Left Sidebar' => __('Left Sidebar','jeweller-store'),
            'Right Sidebar' => __('Right Sidebar','jeweller-store'),
            'Three Column' => __('Three Column','jeweller-store'),
            'Four Column' => __('Four Column','jeweller-store'),
            'Grid Layout Without Sidebar' => __('Grid Layout Without Sidebar','jeweller-store'),
            'Grid Layout With Right Sidebar' => __('Grid Layout With Right Sidebar','jeweller-store'),
            'Grid Layout With Left Sidebar' => __('Grid Layout With Left Sidebar','jeweller-store')
		],
	] );
	...
	[
		...
		'choices'     => [
			...
			'unset' => esc_html__( 'unset', 'jeweller-store' ),
		],
	] );
...
$jeweller_store_config_customizer = array(
    'recommended_plugins' => array( 
        'kirki' => array(
            'recommended' => true,
            'description' => sprintf( 
                /* translators: %s: plugin name */
                esc_html__( 'If you want to show all the sections of the FrontPage, please install and activate %s plugin', 'jeweller-store' ), 
                '<strong>' . esc_html__( 'Kirki Customizer', 'jeweller-store' ) . '</strong>'
            ),
        ),
    ),
    'jeweller_store_recommended_actions'       => array(),
    'jeweller_store_recommended_actions_title' => esc_html__( 'Recommended Actions', 'jeweller-store' ),
    'jeweller_store_recommended_plugins_title' => esc_html__( 'Recommended Plugin', 'jeweller-store' ),
    'jeweller_store_install_button_label'      => esc_html__( 'Install and Activate', 'jeweller-store' ),
    'jeweller_store_activate_button_label'     => esc_html__( 'Activate', 'jeweller-store' ),
    'jeweller_store_deactivate_button_label'   => esc_html__( 'Deactivate', 'jeweller-store' ),
);

Jeweller_Store_Customizer_Notify::init( apply_filters( 'jeweller_store_customizer_notify_array', $jeweller_store_config_customizer ) );